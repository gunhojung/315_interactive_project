...
author: "[(Gunho Jung, gjung), (Joon Woo Baik, joonwoob), (Anne Crumley, acrumley), (Colleen Fang, colleenf)]"
...
* "This submission is for the following group: (Gunho Jung, gjung), 
(Joon Woo Baik, joonwoob), (Anne Crumley, acrumley), (Colleen Fang, colleenf).
...
*  When I hover the mouse over a point, this graph provides specific x 
(eruptions) and y (waiting) values at that point. When I hover over the density 
contours but not over a point, it provides a specific level value of one density
contour where the mouse is hovering/pointing at.

*  When I click & drag only vertically just for Week 1 facet, the zoom in effect
on a horizontal slice occurs both for Week 1 and Week 2 facets. No matter which 
facet I choose to click & drag vertically, same zoom in effect is taken into 
account for all the other facets as well. However, if I click & drag 
horizontally, only the facetted variable's zoom in is taken into account. Thus, 
there is an inconsistency of the zoom in functionality in the plotly package, 
depending on how you want the graph to be zoomed in (either horizontally or
vertically).
